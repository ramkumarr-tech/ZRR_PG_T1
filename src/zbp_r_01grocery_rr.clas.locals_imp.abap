CLASS LHC_ZR_01GROCERY_RR DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      GET_GLOBAL_AUTHORIZATIONS FOR GLOBAL AUTHORIZATION
        IMPORTING
           REQUEST requested_authorizations FOR  Grocery  "Zr01groceryRr
        RESULT result,
      checkExpirationDate FOR MODIFY
            IMPORTING keys FOR ACTION Grocery~checkExpirationDate RESULT result.
ENDCLASS.

CLASS LHC_ZR_01GROCERY_RR IMPLEMENTATION.
  METHOD GET_GLOBAL_AUTHORIZATIONS.
  ENDMETHOD.
  METHOD checkExpirationDate.

    DATA: lt_groceries TYPE TABLE FOR READ RESULT zr_01grocery_RR,
          ls_grocery TYPE STRUCTURE FOR READ RESULT zr_01grocery_RR,
          lv_expiration TYPE d,
          lv_current_date TYPE d,
          lv_expired TYPE abap_boolean,
          lt_update_groceries TYPE TABLE FOR UPDATE zr_01grocery_RR.

    READ ENTITIES OF zr_01grocery_RR
    ...
    MODIFY ENTITIES OF zr_01grocery_RR IN LOCAL MODE
      ENTITY Grocery
